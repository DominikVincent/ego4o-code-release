...
class NymeriaDataset_wo_Text(Dataset):
    def __init__(self,
    ...
    def convert_nymeria(self, imu_ori_qwxyz, imu_acc, joint_loc):
        ...
        # pdb.set_trace()
        # check the invalid rotation and convert it to the nearest valid rotation
    ...
    def load_data(self):
        ...
        if self.train == "test":
            lines = lines[:1000]
            print("Warning: only using 1000 samples for testing")
