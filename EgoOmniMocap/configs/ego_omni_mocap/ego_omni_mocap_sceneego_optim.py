...
normalize_trajectory = dict(type='NormalizeTrajectory', key='traj_data',
                            ...
                            control_joint_ids=(15, 20, 21, 10, 11),)
...
val_pipeline = [
    ...
    dict(type='ToFloatTensor',
         keys=['traj_data', 'init_aligned_global_smpl_joints', 'gt_joints_3d', 'root_init_xz', 'root_quat_init']
         ),
    normalize_trajectory,
    dict(
        type='Collect',
        keys=['traj_data', 'lengths',],  # todo: pad the data
        meta_keys=['init_aligned_global_smpl_joints', 'lengths', 'gt_joints_3d', 'root_init_xz', 'root_quat_init'],
        meta_name='data_samples'
    )
]
...
val_dataloader = dict(
    ...
    collate_fn=dict(type='default_collate'),
    dataset=dict(
        type='SceneEgoTestDataset',
        data_pkl_path='/CT/EgoMocap/work/EgocentricFullBody/work_dirs/egofullbody_test_b_256/results.pkl',
...
# evaluators
val_evaluator = [
    dict(type='SceneEgoMPJPE', mode='mpjpe',
         ...
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/ego_omni_mocap_sceneego_optim/results.pkl'),
    dict(type='SceneEgoMPJPE', mode='p-mpjpe',
         motion_mean_path='/CT/EgoMocap/work/EgoOmniMocap/projects/TLControl/demo/info_motion_mean.pt',
         motion_std_path='/CT/EgoMocap/work/EgoOmniMocap/projects/TLControl/demo/info_motion_std.pt'),
    dict(type='DumpResults',
         out_file_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/ego_omni_mocap_sceneego_optim/results_save.pkl')
]
