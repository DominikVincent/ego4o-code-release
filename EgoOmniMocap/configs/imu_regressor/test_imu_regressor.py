...
# wandb logger
visualizer = dict(
    type='Visualizer', vis_backends=[dict(type='WandbVisBackend', init_kwargs=dict(project='imu_regressor'))])
...
# evaluators
val_evaluator = [
    # todo: modify the evaluator here
    ...
    dict(type='MyDumpResults',
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/test_imu_regressor/results.pkl')
]
