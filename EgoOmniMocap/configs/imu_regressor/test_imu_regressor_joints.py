...
# wandb logger
visualizer = dict(
    type='Visualizer', vis_backends=[dict(type='WandbVisBackend', init_kwargs=dict(project='imu_regressor_joints'))])
...
val_evaluator = [
    dict(type='MyDumpResults',
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/test_imu_regressor_joints/results.pkl')
]
