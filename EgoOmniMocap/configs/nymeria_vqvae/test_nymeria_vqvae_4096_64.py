...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='test_nymeria_vq_vae'))])
...
# evaluators
val_evaluator = [
    dict(type='EgoOmniMocapError', mode=('pa-mpjpe', 'c-mpjpe'),
         ...
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/vqvae_for_visualization/results_save.pkl'),
]
