...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='nymeria_random_text'))])
...
val_evaluator = [
    dict(type='AgrolMPJPE', mode='c-mpjpe',
         ...
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/test_nymeria_with_text/results_save_h_w_gen_text.pkl',
         save_keys=('motion_file', 'motion_id'),
         nymeria_mask=True,
         ),
