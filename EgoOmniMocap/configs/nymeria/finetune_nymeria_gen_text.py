...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='finetune_gen_text'))])

# runtime
train_cfg = dict(max_epochs=28, val_interval=1)

# optimizer
optim_wrapper = dict(
    optimizer=dict(type='Adam', lr=5e-6),
)
...
train_pipeline = [
    ...
    dict(type='AddGeneratedText',
         text_json_file=['/CT/EgoMocap/work/LLaVA/eval_out/nymeria_train10_29_02_43_12/result.json',
                         '/CT/EgoMocap/work/LLaVA/eval_out/test_nymeria10_28_23_51_09/result.json']
         ),
    dict(
        type='Collect',
