...
pretrained_imu_regressor_path = '/CT/EgoMocap/work/EgoOmniMocap/work_dirs/train_imu_regressor/epoch_300.pth'

model = dict(
    type='IMUPoserEncoderRegressorOptim',
    input_dim=3 + 6,
    sensor_num=6,
    seq_len=196,
    drop_out=0.1,
    ...
    imu_regressor_weight=pretrained_imu_regressor_path,
)
...
val_evaluator = [
    dict(type='AgrolMPJPE', mode='c-mpjpe',
         ...
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/test_imuposer_imu_regressor/results_save_h_no_reg_imu.pkl'),
