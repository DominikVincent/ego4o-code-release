...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='imuposer_text'))])
...
#          save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/test_imuposer_dataset_text_mask/results_save_all_w_text_optim.pkl',
#          max_save_length=-1),
