...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='for_vis_test_nymeria_image_text'))])
...
train_pipeline = [
    ...
    #      text_json_file='/CT/EgoMocap/work/LLaVA/vis_out/output_text_list.json'
    #      ),
...
val_dataset = dict(
    ...
    with_text=True,
    test_data_len=None,
    motion_id_list=['193_20230815_s1_lisa_colon_act3_okbf3p', '194_20230815_s1_lisa_colon_act3_okbf3p',
                     '195_20230815_s1_lisa_colon_act3_okbf3p', '196_20230815_s1_lisa_colon_act3_okbf3p']
)
...
val_evaluator = [
    dict(type='EgoOmniMocapError', mode=('pa-mpjpe', 'c-mpjpe', 'jitter-pred', 'jitter-gt', 'global-angle'),
         ...
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/for_visualization/results_save_global_4_motion.pkl'),
]
