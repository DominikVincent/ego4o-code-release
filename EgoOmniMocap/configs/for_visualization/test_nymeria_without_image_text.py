...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='test_nymeria_random_image_text'))])
...
val_evaluator = [
    dict(type='EgoOmniMocapError', mode=('pa-mpjpe', 'c-mpjpe', 'jitter-pred', 'jitter-gt', 'global-angle'),
         ...
         save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/for_visualization/results_save_rw_no_text_image.pkl'),
]
