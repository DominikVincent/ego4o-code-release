...
visualizer = dict(type='Visualizer', vis_backends=[dict(type='WandbVisBackend',
                                                        init_kwargs=dict(project='imuposer_finetune'))])
...
# load model from ....
load_from = '/CT/EgoMocap/work/EgoOmniMocap/work_dirs/train_imuposer_dataset_mask/best_C-MPJPE_epoch_6.pth'
...
val_evaluator = [
    dict(type='AgrolMPJPE', mode='c-mpjpe',
         ...
         # save_path='/CT/EgoMocap/work/EgoOmniMocap/work_dirs/test_imuposer_dataset_mask/results_save.pkl'
         ),
