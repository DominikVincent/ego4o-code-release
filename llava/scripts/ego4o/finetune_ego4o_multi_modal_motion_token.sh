...
NCCL_SOCKET_IFNAME=lo deepspeed llava/ego4o/train/train_mem_ego4o.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/multi_modal_finetune_motion_token \
    --num_train_epochs 2 \
