...
def main(args):
    motion_file_id = args.motion_file_id
    ...
    joints_seq_nymeria = motion_data['segment_tXYZ']
    ...
    joints_seq_nymeria[:, :, 0] -= joints_seq_nymeria[0:1, 0:1, 0]
    joints_seq_nymeria[:, :, 1] -= joints_seq_nymeria[0:1, 0:1, 1]
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--motion_file_id', type=str, help='Path to the motion file')
