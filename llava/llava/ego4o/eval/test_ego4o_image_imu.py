...
def eval_model(args):
    ...
    for data_idx in tqdm(range(len(test_dataset))):
        # if data_idx > 10:
        #     break
        conversation = test_dataset[data_idx]['conversations']
        query = "<image>\n<motion>\nCan you describe the motion of the person?"
        # query = "<image>\n<motion>\nCan you describe the motion of the person? Can you describe the motion of the person?"
        # query = "<image>\nCan you describe the motion of the person?"
        # query = "<motion>\nCan you describe the motion of the person?"
        conv_mode = "v1"
        ...
        print(f"Model inference time: {elapsed_time_ms:.3f} ms")

        device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
        # print(f"Memory used after eval step: {torch.cuda.memory_allocated(device) / (1024 ** 2):.2f} MB")
        ...
        # image_file = test_dataset[data_idx]['img_path']
        # # for image_file in test_dataset[data_idx]['img_for_imu']:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default='/home/jianwang/EgoMocap/work/LLaVA/rebuttal')
