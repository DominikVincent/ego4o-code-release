...
class QuantizeEMAReset(nn.Module):
    ...
    def update_codebook(self, x, code_idx):
        ...
        code_onehot = code_onehot.to(dtype=x.dtype)
        ...
        usage = (self.code_count.view(self.nb_code, 1) >= 1.0).to(dtype=x.dtype)
    ...
    def quantize(self, x):
        ...
        k_w = self.codebook.t().to(dtype=x.dtype)
    ...
    def forward(self, x):
        ...
        # Passthrough
        x_d = x + (x_d - x).detach()   #### due to numerical stableness...
